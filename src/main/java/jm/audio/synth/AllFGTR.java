 ...
 *
 * @author Timothy Opie
 * @version 1.0, Wednesday November 12, 2003 Last changed: Description: This class takes a stream of
 *          audio data and reduces it to grain information comprising solely of a start and finish
...
public final class AllFGTR extends AudioObject {
  ...
  public int work(float[] buffer) throws AOException {
    ...
    for (gCounter = 0; gCounter < grainsPerBuffer; gCounter++) {
      ...
      if ((gCounter + 1) * interOnset + grainDuration > buffer.length) {
        gCounter = grainsPerBuffer; //safety backup
      }
