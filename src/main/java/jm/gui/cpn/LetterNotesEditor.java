...
public class LetterNotesEditor extends Dialog
  ...
  private void processChar(char c) {
    switch (c) {
      ...
      case '1':
        moveToInterval(JMC.cf1, JMC.bs1);
        break;
      case '2':
        moveToInterval(JMC.cf2, JMC.bs2);
        break;
      case '3':
        moveToInterval(JMC.cf3, JMC.bs3);
        break;
      case '4':
        moveToInterval(JMC.cf4, JMC.bs4);
        break;
      case '5':
        moveToInterval(JMC.cf5, JMC.bs5);
        break;
      case '6':
        moveToInterval(JMC.cf6, JMC.bs6);
        break;
      case '7':
        moveToInterval(JMC.cf7, JMC.bs7);
        break;
      case '8':
        moveToInterval(JMC.cf8, JMC.bs8);
        break;
      case '9':
        moveToInterval(JMC.cf9, JMC.g9);
        break;
