...
*/
  ...
  */
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource() == size16) {
      setResolution(16);
    }
    if (e.getSource() == size32) {
      setResolution(32);
    }
    if (e.getSource() == size64) {
      setResolution(64);
    }
    if (e.getSource() == size128) {
      setResolution(128);
    }
    if (e.getSource() == size256) {
      setResolution(256);
    }
    if (e.getSource() == size512) {
      setResolution(512);
    }
    if (e.getSource() == size1024) {
      setResolution(1024);
    }
    if (e.getSource() == size2048) {
      setResolution(2048);
    }
    ...
    if (e.getSource() == times1) {
      setAmplitude(1);
    }
    if (e.getSource() == times2) {
      setAmplitude(2);
    }
    if (e.getSource() == times3) {
      setAmplitude(3);
    }
    if (e.getSource() == times4) {
      setAmplitude(4);
    }
  ...
  public void setResolution(int size) {
    if (size > 0 && size <= 2048) { // 8000
      ...
      if (afr.getWaveSize() / resolution < width) {
        startPos = 0;
      }
      reRead();
