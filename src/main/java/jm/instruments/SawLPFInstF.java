...
public final class SawLPFInstF extends Instrument {
  ...
  public void createChain() {
    ...
    Oscillator wave = new Oscillator(this, Oscillator.SAWTOOTH_WAVE, this.sampleRate,
      this.channels);
    Oscillator wave2 = new Oscillator(this, Oscillator.SAWTOOTH_WAVE, this.sampleRate,
      this.channels);
    wave2.setFrqRatio((float) 1.001); // for effect try 1.02
    Add summedWaves = new Add(new AudioObject[]{wave, wave2});
    Filter filt = new Filter(new AudioObject[]{summedWaves, mult}, this.filterCutoff,
      Filter.LOW_PASS);
