...
/**
 * The Score class is used to hold score data.  Score data includes is primarily made up of a vector
 * of Part objects. Commonly score data is algorithmically generated or read from a standard MIDI
 * file, but can also be read and saved to file using Java's object serialization. In this way a
 * Score's data can be saved in a more native context. To find out how to read from and write to
 * standard MIDI files or to use object serializationcheck out the jm.util.Read and km.util.Write
 * classes.
 *
