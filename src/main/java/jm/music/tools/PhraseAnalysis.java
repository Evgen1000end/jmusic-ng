...
public final class PhraseAnalysis {
   ...
   * @return double describing the fraction of distinct pitches per note in the Phrase
   ...
   *
   * @param noteArray array of Notes to be examined
   * @return double describing the fraction of distinct pitches per note in the Note array
   ...
   *
   * @param phrase Phrase to be analysed
   * @return double descring the pitch range per <CODE>MAX_PITCH_RANGE</CODE>
   * @throws NoteListException if there are no <A HREF="#Note">notes</A> in the Phrase
   */
   ...
   *
   * @param phrase Phrase to be analysed
   * @return double descring the rhythm range per <CODE>MAX_RHYTHM_RANGE</CODE>
   * @throws NoteListException if there are no <A HREF="#Note">notes</A> in the Phrase
   */
   ...
   *
   * @param noteArray Note array to be analysed
   * @return double descring the pitch range per <CODE>MAX_RHYTHM_RANGE</CODE>
   * @throws NoteListException if there are no <A HREF="#Note">notes</A> in the Phrase
   */
   ...
   *
   * @param phrase Phrase whose notes are to be counted
   * @return integer describing the number of non-rest Notes in the Phrase
   */
   ...
   * @return integer describing the number of non-rest Notes in the Note array.
   */
   ...
   *
   * @param phrase Phrase to be examined
   * @return integer describing the number of distinct pitches in the Phrase
   */
   ...
   *
   * @param noteArray array of Note objects to be examined
   * @return integer describing the number of distinct pitches in the Note array
   */
   ...
   * @return integer describing the difference between the highest and lowest pitches
   * @throws NoteListException if there are no <A HREF="#Note">notes</A> in the Phrase
   */
   ...
   *
   * @param phrase Phrase whose notes are to be examined
   * @return double describing the longest rhythm value, divided by the shortest
   * @throws NoteListException if there are no <A HREF="#Note">notes</A> in the Phrase
   */
   ...
   *
   * @param phrase Phrase to be analysed
   * @return integer describing the number of intervals with a size of 0 semitones.
   */
   ...
   *
   * @param phrase Phrase to be analysed
   * @return Integer describing the count of consecutive intervals in the same direction
   */
